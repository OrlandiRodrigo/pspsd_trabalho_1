...
# Testes de Integração (API/DB) para os endpoints de Clientes.
# Cobre: Auto-cadastro (PF/PJ), gerenciamento de admin (CRUD) e o portal /minha-empresa.
...
dados_validos_pessoa_fisica = [
    ...
    {
        "email": "teste.param2.comp@email.com",
        "telefone": "22222222222",
        "nome_completo": "Cliente Param Dois Comp",
        "cpf": "22200022200",
        "cnh": "2000000002",
        "senha_texto_puro": "senhaValida2",
        "endereco": {
            "rua": "Rua P2",
            "numero": "2",
            "complemento": "Bloco B",
    ...
    {
        "email": "teste.param3.semcomp@email.com",
        "telefone": "33333333333",
        "nome_completo": "Cliente Param Tres SemComp",
        "cpf": "33300033300",
        "cnh": "3000000003",
        "senha_texto_puro": "senhaValida3",
        "endereco": {
            "rua": "Rua P3",
            "numero": "3",
            "bairro": "B P3",
...
def setup_para_teste_reserva(
    ...
    """Fixture auxiliar para criar 1 admin, 1 cliente e 1 veículo, e retornar os dados."""
...
def test_pessoa_fisica_tenta_acessar_rota_minha_empresa_falha_403(
    ...
    dados_associacao = {"id_pessoa_fisica": 99}
